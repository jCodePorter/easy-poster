...
public class EnhanceTextElementTest {
    ...
    public void shouldApplyRichMaxLinesAfterWrap() {
        EnhanceTextElement element = EnhanceTextElement.richText(
                        TextSpan.of("This").setColor(Color.RED).setUnderline(true),
                        TextSpan.of(" rich").setFontStyle(Font.BOLD).setStrikeThrough(true),
        ...
        poster.asFile("png", "apply_rich_max_lines_after_wrap.png");
    }
