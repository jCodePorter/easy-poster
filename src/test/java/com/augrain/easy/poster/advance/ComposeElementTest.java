...
public class ComposeElementTest {
    ...
    public void testLeft() throws Exception {
        EasyPoster canvas = new EasyPoster(1200, 800);
    ...
    public void testIn() throws Exception {
        EasyPoster canvas = new EasyPoster(1200, 1200);
    ...
    public void testInTile() throws Exception {
        EasyPoster canvas = new EasyPoster(3000, 3000);
    ...
    public void testFollow() {
        EasyPoster canvas = new EasyPoster(1000, 200);
