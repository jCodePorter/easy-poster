package com.augrain.easy.poster.verify;

import com.augrain.easy.poster.basic.image.ImageBasicTest;
...
public class GaussianBlur {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int pixel = 0;
        int[][][] picture = new int[3][read.getWidth()][read.getHeight()];
        ...
        picture = GaussianBlur.gaussianBlur(picture, 50, 20);  // 快速高斯模糊
        ...
        // 将模糊后的图像保存到指定路径
        ImageIO.write(out, "png", new File("blur.png"));
    }
}